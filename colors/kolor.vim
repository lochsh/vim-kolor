...
highlight SpecialKey      guifg=#3f8efc    guibg=NONE       gui=none
highlight NonText         guifg=#3f8efc    guibg=#232321    gui=none
...
highlight SpellRare       guifg=NONE       guibg=NONE       gui=undercurl    guisp=#5fd967
highlight SpellLocal      guifg=NONE       guibg=NONE       gui=undercurl    guisp=#dbc570
highlight Pmenu           guifg=#c6c6c6    guibg=#242322    gui=none
highlight PmenuSel        guifg=#000000    guibg=#3f8efc    gui=none
...
if g:kolor_bold==0
  ...
  highlight MoreMsg         guifg=#5fd967    guibg=NONE       gui=none
  ...
  highlight MoreMsg         guifg=#5fd967    guibg=NONE       gui=bold
...
if g:kolor_italic==0
    ...
    highlight String          guifg=#3f8efc    guibg=NONE   gui=none
else
    highlight Comment         guifg=#808080    guibg=NONE   gui=italic
    highlight Constant        guifg=#e6987a    guibg=NONE   gui=italic
    highlight String          guifg=#3f8efc    guibg=NONE   gui=italic
endif
if g:kolor_underlined==0
  highlight Underlined      guifg=#3f8efc    guibg=NONE   gui=none
else
  highlight Underlined      guifg=#3f8efc    guibg=NONE   gui=underline
endif
...
if &t_Co > 255
  ...
  highlight PreProc         ctermfg=208     ctermbg=none    cterm=none
  highlight String          ctermfg=75     ctermbg=none    cterm=none
  highlight Number          ctermfg=186     ctermbg=none    cterm=none
  highlight Function        ctermfg=42     ctermbg=none    cterm=none
  highlight htmlEndTag      ctermfg=42     ctermbg=none    cterm=none
  highlight xmlEndTag       ctermfg=42     ctermbg=none    cterm=none
  if g:kolor_bold==0
    highlight ErrorMsg        ctermfg=162     ctermbg=none    cterm=none
    ...
    highlight Statement       ctermfg=162     ctermbg=none    cterm=none
    highlight Type            ctermfg=141     ctermbg=none    cterm=none
    highlight Error           ctermfg=162     ctermbg=none    cterm=none
    ...
    highlight ErrorMsg        ctermfg=162     ctermbg=none    cterm=bold
    ...
    highlight Statement       ctermfg=162     ctermbg=none    cterm=bold
    highlight Type            ctermfg=141     ctermbg=none    cterm=bold
    highlight Error           ctermfg=162     ctermbg=none    cterm=bold
  ...
  if g:kolor_underlined==0
    highlight Underlined      ctermfg=75     ctermbg=none    cterm=none
  else
    highlight Underlined      ctermfg=75     ctermbg=none    cterm=underline
  endif
end
